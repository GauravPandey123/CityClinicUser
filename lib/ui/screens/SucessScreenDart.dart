    ...
    return Scaffold(
      body: Container(
        ...
        children: <Widget>[
          ...
          SizedBox(height: 20),
          Text("Success",style: TextStyle(fontSize: 20.0,color: blackOneColor),),
          SizedBox(height: 10),
          Text("Thank you for choosing City Clinic",style: TextStyle(fontSize: 20.0,color: normaltextColor),),
          SizedBox(height: 30),
          FlatButton(
            height: 50,
            minWidth: 200,
